...
public class banditScript : MonoBehaviour
{
    ...
    public enum Banditstate { walking, attack};
    public enum Attackstate { startAttack, lookAtPlayer, checkPlayer, walkToPlayer }
    [Header("Attack")]
    public Banditstate banditstate = Banditstate.walking;
    ...
    void FixedUpdate()
    {
        ...
        {
            banditstate = Banditstate.walking;
        }
        
        vectorToPlayer = playerTransform.position - transform.position;
        float distanceToPlayer = vectorToPlayer.magnitude;

        if (distanceToPlayer <= aggroRadius && banditstate == Banditstate.walking)
        {
        ...
        if (banditstate == Banditstate.walking && canWalk)
        {
            initialAttack = true;
